...
;~ 	Scanner_AddPattern('WorldConst', "P:\Code\Gw\Const\ConstWorld.cpp", "index < arrsize(s_worldData)", 'Ptr', 0x16)
	...
	Scanner_AddPattern('CompassFlag', '8D451050566A5B57', 0x1, 'Func')
	...
	Scanner_AddPattern('SetDifficulty', '83C41C6828010010FF7604', 0x8C, 'Func')
	...
	Scanner_AddPattern('HookedTrader', '8D4DFC51576A5450', -0x3C, 'Hook')
