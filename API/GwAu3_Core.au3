...
;~ 	Scanner_AddPattern('CompassFlag', '8D451050566A4E57', -0x1F, 'Func')
	Scanner_AddPattern('CompassFlag', '8D451050566A5B57', -0x1F, 'Func')
	Scanner_AddPattern('PartySearchButtonCallback', '8B450883EC08568BF18B480483F90D', -0x2, 'Func')
;~  Scanner_AddPattern('PartyWindowButtonCallback','', , 'Func')
	...
	Scanner_AddPattern('SetDifficulty', '8B068D4E0883C424518BCEFF10FF7510', 0x7C, 'Func')
	...
	Scanner_AddPattern('Render', 'F6C401741C6845020000BA', -0x68, 'Hook')
	Scanner_AddPattern('LoadFinished', '2BD9C1E303', 0xA0, 'Hook')
;~  Scanner_AddPattern('HookedTrader', '', , 'Hook')
