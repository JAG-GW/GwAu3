...
Func Map_GetConnectedMaps($a_i_MapID)
	...
	Switch $a_i_MapID
		...
		Case $GC_I_MAP_ID_BUKDEK_BYWAY
			Local $l_a_Connected[] = [$GC_I_MAP_ID_KAINENG_CENTER, $GC_I_MAP_ID_SHADOWS_PASSAGE, $GC_I_MAP_ID_THE_MARKETPLACE, $GC_I_MAP_ID_VIZUNAH_SQUARE_FOREIGN_QUARTER, $GC_I_MAP_ID_XAQUANG_SKYWAY] ;$GC_I_MAP_ID_THE_UNDERCITY
		Case $GC_I_MAP_ID_XAQUANG_SKYWAY
