...
Global Enum $all = 0, $SkillID, $Campaign, $SkillType, $Special, $ComboReq, $Effect1, $RequireCondition, $Effect2, $WeaponReq, $Profession, _ ;10
        $Attribute, $Title, $SkillIDPvP, $Combo, $Target, $SkillEquipType, $Overcast, $EnergyCost, $HealthCost, $Adrenaline, $Activation, $Aftercast, _ ;12
        $Duration0, $Duration15, $Recharge, $SkillArguments, $Scale0, $Scale15, $BonusScale0, $BonusScale15, $EffectConstant1, $EffectConstant2, _ ;10
        $CasterOverheadAnimationID, $CasterBodyAnimationID, $TargetBodyAnimationID, $TargetOverheadAnimationID, $ProjectileAnimation1ID, $ProjectileAnimation2ID, _ ;6
        $IconFileID, $IconFileID2, $Name, $Concise, $Description ;5


Global $BestTarget = 0
Global $LastCalledTarget = 0
Global $SkillBarCache[9][44]
Global $Skillbar[8] = [1, 2, 3, 4, 5, 6, 7, 8]
Global $SkillbarSlot[3500]	; used to store the skillslot of skill ID's present in the skill bar
Global $BestTargetCache[9]
Global $CanUseCache[9]
Global $CanUseSkill = True
Global $SkillChanged = False

Global $lSet_1[6] = [0, 0, 0, 0, 0, 0]
Global $lSet_2[6] = [0, 0, 0, 0, 0, 0]
Global $lSet_3[6] = [0, 0, 0, 0, 0, 0]
Global $lSet_4[6] = [0, 0, 0, 0, 0, 0]
;[Energy, Set]
Global $High_Hp_Set[2] = [0, 0]
Global $High_Energy_Set[2] = [0, 0]
;4 = set / 2 = weapon / 8 = Mods
Global $Weapon_Mods[4][2][8] = [ _
...
#Region Mods
Global $array_OtherWeaponsMods [24][3] = [ _
...
;[Name, effect, mods]
Global $array_MartialWeaponsInscription[11][3] = [ _
...
Global $array_SpellCastingWeaponsInscription[15][3] = [ _
	...
	["Don't Fear the Reaper",			"Damage 20% (while Hexed)",				"14009822"], _
	["Don't Think Twice",				"HCT10",								"000A0822"]]
Global $array_FocusShieldWeaponsInscription[34][3] = [ _
...
Global $array_AxeUpgrade[30][3] = [ _
...
Global $array_HammerUpgrade[27][3] = [ _
	["Cruel",							"Deep Wound +33%",						"E2016824"], _
	["Heavy",							"Weakness +33%", 						"E601824"], _
	["Ebon",							"Earth damage",							"000BB824"], _
	["Fiery",							"Fire damage", 							"0005B824"], _
...
Global $array_SwordUpgrade[29][3] = [ _
	["Barbed",							"Bleeding +33%", 						"DE016824"], _
	["Cruel",							"Deep Wound +33%",						"E2016824"], _
	["Crippling",						"Crippled +33%",						"E1016824"], _
	["Poisonous",						"Poison +33%", 							"E4016824"], _
...
Global $array_DaggerUpgrade[20][3] = [ _
	["Barbed",							"Bleeding +33%", 						"DE016824"], _
	["Cruel",							"Deep Wound +33%",						"E2016824"], _
	["Crippling",						"Crippled +33%",						"E1016824"], _
	["Heavy",							"Weakness +33%", 						"E601824"], _
...
Global $array_ScytheUpgrade[19][3] = [ _
	["Barbed",							"Bleeding +33%", 						"DE016824"], _
	["Cruel",							"Deep Wound +33%",						"E2016824"], _
	["Crippling",						"Crippled +33%",						"E1016824"], _
	["Heavy",							"Weakness +33%", 						"E601824"], _
...
Global $array_BowUpgrade[29][3] = [ _
	["Barbed",							"Bleeding +33%", 						"DE016824"], _
	["Crippling",						"Crippled +33%",						"E1016824"], _
	["Poisonous",						"Poison +33%", 							"E4016824"], _
	["Silencing",						"Dazed +33%", 							"E5016824"], _
...
Global $array_SpearUpgrade[20][3] = [ _
	["Barbed",							"Bleeding +33%", 						"DE016824"], _
	["Cruel",							"Deep Wound +33%",						"E2016824"], _
	["Crippling",						"Crippled +33%",						"E1016824"], _
	["Heavy",							"Weakness +33%", 						"E601824"], _
...
Global $array_StaffWandUpgrade[28][3] = [ _
...
Global $array_ShieldUpgrade[5][3] = [ _
...
Global $array_FocusUpgrade[7][3] = [ _
