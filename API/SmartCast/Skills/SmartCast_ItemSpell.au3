...
Func BestTarget_GenerousWasTsungrai($aAggroRange)
...
Func BestTarget_MightyWasVorizun($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_BlindWasMingson($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GraspingWasKuurong($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_VengefulWasKhanhei($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_DefiantWasXinrae($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_TranquilWasTanasen($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_CruelWasDaoshen($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_ProtectiveWasKaolai($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_AttunedWasSongkai($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_ResilientWasXiko($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_LivelyWasNaomei($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_AnguishedWasLingwah($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_VocalWasSogolon($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_DestructiveWasGlaive($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_EnergeticWasLeeSa($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_PureWasLiMing($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_CourageousWasSaidra($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_ProtectiveWasKaolaiPvp($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_DestructiveWasGlaivePvp($aAggroRange)
	Return Agent_GetMyID()
EndFunc
