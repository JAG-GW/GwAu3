...
Func BestTarget_GlyphOfElementalPower($aAggroRange)
...
Func BestTarget_GlyphOfEnergy($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfLesserEnergy($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfConcentration($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfSacrifice($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfRenewal($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_HiddenRock($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfEssence($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfRestoration($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfSwiftness($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GlyphOfImmolation($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_PolymockGlyphOfConcentration($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_PolymockGlyphOfPower($aAggroRange)
	Return Agent_GetMyID()
EndFunc
