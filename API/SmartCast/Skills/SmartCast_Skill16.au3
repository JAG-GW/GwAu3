...
Func BestTarget_DefyPain($aAggroRange)
...
Func BestTarget_EndurePain($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_WarriorsCunning($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_ShieldBash($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_WarriorsEndurance($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_HundredBlades($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_Riposte($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_DeadlyRiposte($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_VictoryOrDeath($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_CriticalEye($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_AuraOfTheJuggernaut($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RitualLord($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_SoulTwisting($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_EtherPrism($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RageOfTheNtouka($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RoughCurrent($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_TurbulentFlow($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_ExtendEnchantments($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_CurseOfTheStaffOfTheMists($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_AuraOfTheStaffOfTheMists($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_PowerOfTheStaffOfTheMists($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_DrakeSkin($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_SkaleVigor($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_PahnaiSaladItemEffect($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_Untouchable($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RampageAsOne($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_FocusedAnger($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_NaturalTemper($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_Enraged($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_Ram($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_HardenShell($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RollerbeetleDash($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_SuperRollerbeetle($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RollerbeetleEcho($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GoldenEggSkill($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_BirthdayCupcakeSkill($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_Intensity($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_NeverRampageAlone($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_BurningShield($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_FeelNoPain($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_UrsanForce($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_CandyCornSkill($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_CandyAppleSkill($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_PieInducedEcstasy($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_VictoryIsOurs($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_FalkenQuick($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RitualLordPvp($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_SummoningSickness($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_YoHoHoAndABottleOfGrog($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_AmuletOfProtection2($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_OversizedTonicWarning($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_BlueRockCandyRush($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_GreenRockCandyRush($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_RedRockCandyRush($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_WeakenedByDhuum($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_DhuumSkill($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_WellSupplied($aAggroRange)
	Return Agent_GetMyID()
EndFunc
...
Func BestTarget_SpectralInfusion($aAggroRange)
	Return Agent_GetMyID()
EndFunc
