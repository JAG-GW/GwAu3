...
Func GwAu3_AttributeMod_IncreaseAttribute($a_i_AttributeID, $a_i_Amount = 1, $a_i_HeroNumber = 0)
    ...
    For $l_i_Idx = 1 To $a_i_Amount
        ...
        If $a_i_HeroNumber <> 0 Then
            DllStructSetData($g_d_IncreaseAttribute, 3, GwAu3_PartyMod_GetMyPartyHeroInfo($a_i_HeroNumber, "AgentID"))
        Else
...
Func GwAu3_AttributeMod_DecreaseAttribute($a_i_AttributeID, $a_i_Amount = 1, $a_i_HeroNumber = 0)
    If $a_i_AttributeID < 0 Or $a_i_AttributeID > 44 Then
        GwAu3_Log_Error("Invalid attribute ID: " & $a_i_AttributeID, "AttributeMgr", $g_h_EditText)
        Return False
    EndIf
    ...
    For $l_i_Idx = 1 To $a_i_Amount
        ...
        If $a_i_HeroNumber <> 0 Then
            DllStructSetData($g_d_DecreaseAttribute, 3, GwAu3_PartyMod_GetMyPartyHeroInfo($a_i_HeroNumber, "AgentID"))
        Else
...
Func GwAu3_AttributeMod_LoadSkillTemplate($a_s_Template, $a_i_HeroNumber = 0)
    Local $l_i_HeroID
    If $a_i_HeroNumber <> 0 Then
    ...
    If $l_i_ProfPrimary <> GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Primary") Then
        GwAu3_Log_Error("Primary profession mismatch. Template: " & $l_i_ProfPrimary & ", Character: " & GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Primary"), "LoadTemplate", $g_h_EditText)
        Return False
    EndIf
    ...
    Local $l_i_PrimaryAttribute = GwAu3_AttributeMod_GetProfPrimaryAttribute($l_i_ProfPrimary)
    ...
    If Not GwAu3_AttributeMod_LoadAttributes($l_ai2_Attributes, $l_i_ProfSecondary, $a_i_HeroNumber) Then
...
Func GwAu3_AttributeMod_LoadAttributes($a_ai2_AttributesArray, $a_i_SecondaryProfession, $a_i_HeroNumber = 0)
    Local $l_i_HeroID
    If $a_i_HeroNumber <> 0 Then
        $l_i_HeroID = GwAu3_PartyMod_GetMyPartyHeroInfo($a_i_HeroNumber, "AgentID")
        If $l_i_HeroID = 0 Then
    ...
    If $a_i_SecondaryProfession <> 0 And _
       GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Secondary") <> $a_i_SecondaryProfession And _
       GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Primary") <> $a_i_SecondaryProfession Then
        ...
        Do
            ...
            Do
                Sleep(32)
            Until GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Secondary") = $a_i_SecondaryProfession Or TimerDiff($l_i_Deadlock) > $l_i_Timeout

            $l_i_RetryCount += 1
        Until GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Secondary") = $a_i_SecondaryProfession Or $l_i_RetryCount >= $l_i_MaxRetries

        If GwAu3_PartyMod_GetPartyProfessionInfo($l_i_HeroID, "Secondary") <> $a_i_SecondaryProfession Then
    ...
    While GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_PrimaryAttribute, $a_i_HeroNumber, "BaseLevel") > $a_ai2_AttributesArray[0][1]
        $l_i_Level = GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_PrimaryAttribute, $a_i_HeroNumber, "BaseLevel")
        $l_i_Deadlock = TimerInit()

        If Not GwAu3_AttributeMod_DecreaseAttribute($l_i_PrimaryAttribute, 1, $a_i_HeroNumber) Then
        ...
        Do
            Sleep(32)
        Until GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_PrimaryAttribute, $a_i_HeroNumber, "BaseLevel") < $l_i_Level Or TimerDiff($l_i_Deadlock) > $l_i_Timeout
    ...
    For $l_i_Idx = 1 To UBound($a_ai2_AttributesArray) - 1
        ...
        While GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_AttrID, $a_i_HeroNumber, "BaseLevel") > $l_i_TargetLevel
            $l_i_Level = GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_AttrID, $a_i_HeroNumber, "BaseLevel")
            $l_i_Deadlock = TimerInit()

            If Not GwAu3_AttributeMod_DecreaseAttribute($l_i_AttrID, 1, $a_i_HeroNumber) Then
            ...
            Do
                Sleep(32)
            Until GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_AttrID, $a_i_HeroNumber, "BaseLevel") < $l_i_Level Or TimerDiff($l_i_Deadlock) > $l_i_Timeout
    ...
    For $l_i_Idx = 0 To 44
        If GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_Idx, $a_i_HeroNumber, "BaseLevel") > 0 Then
            ...
            While GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_Idx, $a_i_HeroNumber, "BaseLevel") > 0
                $l_i_Level = GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_Idx, $a_i_HeroNumber, "BaseLevel")
                $l_i_Deadlock = TimerInit()

                If Not GwAu3_AttributeMod_DecreaseAttribute($l_i_Idx, 1, $a_i_HeroNumber) Then
                ...
                Do
                    Sleep(32)
                Until GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_Idx, $a_i_HeroNumber, "BaseLevel") < $l_i_Level Or TimerDiff($l_i_Deadlock) > $l_i_Timeout
    ...
    While GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_PrimaryAttribute, $a_i_HeroNumber, "BaseLevel") < $a_ai2_AttributesArray[0][1]
        ...
        If Not GwAu3_AttributeMod_IncreaseAttribute($l_i_PrimaryAttribute, 1, $a_i_HeroNumber) Then
    ...
    For $l_i_Idx = 1 To UBound($a_ai2_AttributesArray) - 1
        ...
        While GwAu3_AttributeMod_GetPartyAttributeInfo($l_i_AttrID, $a_i_HeroNumber, "BaseLevel") < $l_i_TargetLevel
            ...
            If Not GwAu3_AttributeMod_IncreaseAttribute($l_i_AttrID, 1, $a_i_HeroNumber) Then
