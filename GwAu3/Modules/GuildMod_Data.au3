...
Func GwAu3_GuildMod_GetMyGuildInfo($a_s_Info = "")
    Local $l_p_Ptr = GwAu3_GuildMod_GetGuildContextPtr()
...
Func GwAu3_GuildMod_GetGuildPlayerInfo($a_i_PlayerIndex, $a_s_Info = "")
    Local $l_p_RosterDataPtr = GwAu3_GuildMod_GetMyGuildInfo("GuildRosterPtr")
    Local $l_i_RosterSize = GwAu3_GuildMod_GetMyGuildInfo("GuildRosterSize")
...
Func GwAu3_GuildMod_GetGuildHistoryEvent($a_i_EventIndex, $a_s_Info = "")
    Local $l_p_HistoryDataPtr = GwAu3_GuildMod_GetMyGuildInfo("GuildHistoryPtr")
    Local $l_i_HistorySize = GwAu3_GuildMod_GetMyGuildInfo("GuildHistorySize")
...
Func GwAu3_GuildMod_GetTownAllianceInfo($a_i_AllianceIndex, $a_s_Info = "")
    Local $l_p_TownAlliancesPtr = GwAu3_GuildMod_GetMyGuildInfo("TownAlliance")
    Local $l_i_TownAlliancesSize = GwAu3_GuildMod_GetMyGuildInfo("TownAllianceSize")
