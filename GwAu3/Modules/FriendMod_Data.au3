...
Func GwAu3_FriendMod_GetFriendListInfo($a_s_Info = "")
    Local $l_p_Ptr = GwAu3_FriendMod_GetFriendListPtr()
...
Func GwAu3_FriendMod_GetFriendInfo($a_v_FriendIdentifier = "", $a_s_Info = "")
    ...
    Switch $a_s_Info
        ...
        Case "TypeName"
            ...
            Return GwAu3_FriendMod_GetFriendTypeName($l_i_Type)

        Case "StatusName"
            Local $l_i_Status = GwAu3_Memory_Read($l_p_FriendPtr + 0x4, "dword")
            Return GwAu3_FriendMod_GetFriendStatusName($l_i_Status)
...
Func GwAu3_FriendMod_IsFriend($a_s_CharacterName)
    Local $l_p_FriendPtr = GwAu3_FriendMod_GetFriendInfo($a_s_CharacterName, "Ptr")
    If $l_p_FriendPtr = 0 Then Return False

    Return GwAu3_FriendMod_GetFriendInfo($a_s_CharacterName, "Type") = $GC_I_FRIEND_TYPE_FRIEND
EndFunc

Func GwAu3_FriendMod_IsIgnored($a_s_CharacterName)
    Local $l_p_FriendPtr = GwAu3_FriendMod_GetFriendInfo($a_s_CharacterName, "Ptr")
    If $l_p_FriendPtr = 0 Then Return False

    Return GwAu3_FriendMod_GetFriendInfo($a_s_CharacterName, "Type") = $GC_I_FRIEND_TYPE_IGNORE
EndFunc

Func GwAu3_FriendMod_GetFriendStatusName($a_i_FriendStatus)
...
Func GwAu3_FriendMod_GetFriendTypeName($a_i_FriendType)
