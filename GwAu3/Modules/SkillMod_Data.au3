...
Func GwAu3_SkillMod_GetSkillPtr($a_v_SkillID)
    If IsPtr($a_v_SkillID) Then Return $a_v_SkillID
    Local $l_p_SkillPtr = $g_p_SkillBase + 0xA0 * $a_v_SkillID
    Return Ptr($l_p_SkillPtr)
EndFunc

Func GwAu3_SkillMod_GetSkillInfo($a_v_SkillID, $a_s_Info = "")
    Local $l_p_Ptr = GwAu3_SkillMod_GetSkillPtr($a_v_SkillID)
...
Func GwAu3_SkillMod_GetSkillbarInfo($a_i_SkillSlot = 1, $a_s_Info = "", $a_i_HeroNumber = 0)
    Local $l_p_Ptr = GwAu3_OtherMod_GetWorldInfo("SkillbarArray")
    Local $l_i_Size = GwAu3_OtherMod_GetWorldInfo("SkillbarArraySize")
    ...
    Else
        Local $l_i_HeroID = GwAu3_AgentMod_GetMyID()
    EndIf
    ...
    Switch $a_s_Info
        ...
        Case "IsRecharged"
            ...
            Return ($l_i_Timestamp - GwAu3_SkillMod_GetSkillTimer()) = 0

        Case "RawRecharged"
            Local $l_i_Timestamp = GwAu3_Memory_Read($l_p_SkillbarPtr + 0xC + (($a_i_SkillSlot - 1) * 0x14), "dword")
            Local $l_i_SkillID = GwAu3_Memory_Read($l_p_SkillbarPtr + 0x10 + (($a_i_SkillSlot - 1) * 0x14), "dword")
            Return GwAu3_SkillMod_GetSkillInfo($l_i_SkillID, "Recharge") - (GwAu3_SkillMod_GetSkillTimer() - $l_i_Timestamp)
