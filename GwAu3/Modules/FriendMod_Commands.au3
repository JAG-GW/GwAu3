...
Func GwAu3_FriendMod_SetPlayerStatus($a_i_Status)
    ...
    Local $l_i_CurrentStatus = GwAu3_FriendMod_GetMyStatus()
    If $l_i_CurrentStatus = $a_i_Status Then
        GwAu3_Log_Debug("Status already set to: " & GwAu3_FriendMod_GetFriendStatusName($a_i_Status), "FriendMod", $g_h_EditText)
        Return True
    EndIf
    ...
    GwAu3_Log_Info("Changed player status to: " & GwAu3_FriendMod_GetFriendStatusName($a_i_Status), "FriendMod", $g_h_EditText)
    Return True
EndFunc

Func GwAu3_FriendMod_SetOnlineStatus()
    Return GwAu3_FriendMod_SetPlayerStatus($GC_I_FRIEND_STATUS_ONLINE)
EndFunc

Func GwAu3_FriendMod_SetOfflineStatus()
    Return GwAu3_FriendMod_SetPlayerStatus($GC_I_FRIEND_STATUS_OFFLINE)
EndFunc

Func GwAu3_FriendMod_SetDNDStatus()
    Return GwAu3_FriendMod_SetPlayerStatus($GC_I_FRIEND_STATUS_DND)
EndFunc

Func GwAu3_FriendMod_SetAwayStatus()
    Return GwAu3_FriendMod_SetPlayerStatus($GC_I_FRIEND_STATUS_AWAY)
EndFunc
#EndRegion Status Functions

#Region Friend Management Functions
Func GwAu3_FriendMod_AddFriend($a_s_CharacterName, $a_s_Alias = "", $a_i_FriendType = $GC_I_FRIEND_TYPE_FRIEND)
    If Not $g_b_FriendModuleInitialized Then
        GwAu3_Log_Error("FriendMod module not initialized", "FriendMod", $g_h_EditText)
        Return False
    EndIf
    ...
    Local $l_p_ExistingFriend = GwAu3_FriendMod_GetFriendInfo($a_s_CharacterName, "Ptr")
...
Func GwAu3_FriendMod_RemoveFriend($a_s_NameOrAlias)
    If Not $g_b_FriendModuleInitialized Then
        GwAu3_Log_Error("FriendMod module not initialized", "FriendMod", $g_h_EditText)
        Return False
    EndIf
...
Func GwAu3_FriendMod_AddIgnore($a_s_CharacterName, $a_s_Alias = "")
    Return GwAu3_FriendMod_AddFriend($a_s_CharacterName, $a_s_Alias, $GC_I_FRIEND_TYPE_IGNORE)
EndFunc

Func GwAu3_FriendMod_RemoveIgnore($a_s_CharacterName)
    If Not $g_b_FriendModuleInitialized Then
        GwAu3_Log_Error("FriendMod module not initialized", "FriendMod", $g_h_EditText)
        Return False
    EndIf
    ...
    Return GwAu3_FriendMod_RemoveFriend($a_s_CharacterName)
EndFunc
