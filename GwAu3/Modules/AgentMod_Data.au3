...
Func GwAu3_AgentMod_ConvertID($a_i_ID)
	Select
		Case $a_i_ID = -2
...
Func GwAu3_AgentMod_GetAgentPtr($a_i_AgentID = -2)
	If IsPtr($a_i_AgentID) Then Return $a_i_AgentID
	Local $l_a_Offset[3] = [0, 4 * GwAu3_AgentMod_ConvertID($a_i_AgentID), 0]
	Local $l_p_Return = GwAu3_Memory_ReadPtr($g_p_AgentBase, $l_a_Offset)
	Return $l_p_Return[0]
EndFunc

#Region Agent Related
Func GwAu3_AgentMod_GetAgentInfo($a_i_AgentID = -2, $a_s_Info = "")
    Local $l_p_AgentPtr = GwAu3_AgentMod_GetAgentPtr($a_i_AgentID)
    ...
    Switch $a_s_Info
		...
		Case "EffectCount"
            Local $l_i_AgentID = GwAu3_AgentMod_ConvertID($a_i_AgentID)
...
Func GwAu3_AgentMod_GetAgentEquimentInfo($a_i_AgentID = -2, $a_s_Info = "")
	Local $l_p_AgentPtr = GwAu3_AgentMod_GetAgentInfo($a_i_AgentID, "Equipment")
    If $l_p_AgentPtr = 0 Or $a_s_Info = "" Then Return 0
    Switch $a_s_Info
        Case "vtable"
...
Func GwAu3_AgentMod_GetAgentVisibleEffectInfo($a_i_AgentID = -2, $a_s_Info = "")
	Local $l_p_AgentPtr = GwAu3_AgentMod_GetAgentInfo($a_i_AgentID, "VisibleEffectsPtr")
    If $l_p_AgentPtr = 0 Or $a_s_Info = "" Then Return 0
...
Func GwAu3_AgentMod_GetAgentArray($a_i_Type = 0)
    ...
    For $i = 1 To $l_i_MaxAgents
        ...
        If $a_i_Type <> 0 Then
            If GwAu3_AgentMod_GetAgentInfo($l_p_Pointer, "Type") <> $a_i_Type Then ContinueLoop
        EndIf
...
Func GwAu3_AgentMod_GetDistance($a_i_Agent1ID, $a_i_Agent2ID = 0)
    If $a_i_Agent2ID = 0 Then $a_i_Agent2ID = GwAu3_AgentMod_GetMyID()

    Local $l_f_X1 = GwAu3_AgentMod_GetAgentInfo($a_i_Agent1ID, "X")
    Local $l_f_Y1 = GwAu3_AgentMod_GetAgentInfo($a_i_Agent1ID, "Y")
    Local $l_f_X2 = GwAu3_AgentMod_GetAgentInfo($a_i_Agent2ID, "X")
    Local $l_f_Y2 = GwAu3_AgentMod_GetAgentInfo($a_i_Agent2ID, "Y")

    Return Sqrt(($l_f_X1 - $l_f_X2)^2 + ($l_f_Y1 - $l_f_Y2)^2)
EndFunc

#Region Effect Related
Func GwAu3_AgentMod_GetAgentEffectArrayInfo($a_i_AgentID = -2, $a_s_Info = "")
    Local $l_p_Pointer = GwAu3_OtherMod_GetWorldInfo("AgentEffectsArray")
    Local $l_i_Size = GwAu3_OtherMod_GetWorldInfo("AgentEffectsArraySize")
    Local $l_p_AgentPtr = 0

    For $i = 0 To $l_i_Size
        Local $l_p_AgentEffects = $l_p_Pointer + ($i * 0x24)
        If GwAu3_Memory_Read($l_p_AgentEffects, "dword") = GwAu3_AgentMod_ConvertID($a_i_AgentID) Then
...
Func GwAu3_AgentMod_GetAgentEffectInfo($a_i_AgentID = -2, $a_i_SkillID = 0, $a_s_Info = "")
    Local $l_p_EffectArray = GwAu3_AgentMod_GetAgentEffectArrayInfo($a_i_AgentID, "EffectArray")
    Local $l_i_EffectCount = GwAu3_AgentMod_GetAgentEffectArrayInfo($a_i_AgentID, "EffectArraySize")
...
;~             Return GwAu3_Memory_Read($l_p_EffectPtr, "long")
        ...
        Case "TimeElapsed"
            ...
            Return _SkillMod_GetSkillTimer() - $l_i_Timestamp
        Case "TimeRemaining"
            Local $l_i_Timestamp = GwAu3_Memory_Read($l_p_EffectPtr + 0x14, "dword")
            Local $l_i_Duration = GwAu3_Memory_Read($l_p_EffectPtr + 0x10, "float")
            Return $l_i_Duration * 1000 - (_SkillMod_GetSkillTimer() - $l_i_Timestamp)
        Case "HasEffect"
            Return True
        Case Else
            Return 0
...
Func GwAu3_AgentMod_GetAgentBuffInfo($a_i_AgentID = -2, $a_i_SkillID = 0, $a_s_Info = "")
    Local $l_p_BuffArray = GwAu3_AgentMod_GetAgentEffectArrayInfo($a_i_AgentID, "BuffArray")
    Local $l_i_BuffCount = GwAu3_AgentMod_GetAgentEffectArrayInfo($a_i_AgentID, "BuffArraySize")
...
Func GwAu3_AgentMod_GetNpcInfo($a_i_ModelFileID = 0, $a_s_Info = "")
	Local $l_p_Pointer = GwAu3_OtherMod_GetWorldInfo("NpcArray")
	Local $l_i_Size = GwAu3_OtherMod_GetWorldInfo("NpcArraySize")
	Local $l_p_AgentPtr = 0
...
Func GwAu3_AgentMod_GetPlayerInfo($a_i_AgentID = 0, $a_s_Info = "")
    Local $l_p_Pointer = GwAu3_OtherMod_GetWorldInfo("PlayerArray")
    Local $l_i_Size = GwAu3_OtherMod_GetWorldInfo("PlayerArraySize")
    Local $l_p_AgentPtr = 0
...
Func GwAu3_AgentMod_GetPlayerLogInfo($a_s_Info = "")
    Local $l_p_Pointer = GwAu3_OtherMod_GetWorldInfo("PlayerArray")
