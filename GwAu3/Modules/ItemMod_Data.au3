...
Func GwAu3_ItemMod_GetInventoryInfo($a_s_Info = "")
    Local $l_p_Ptr = GwAu3_ItemMod_GetInventoryPtr()
...
Func GwAu3_ItemMod_GetBagPtr($a_v_BagNumber)
...
Func GwAu3_ItemMod_GetBagInfo($a_v_BagNumber, $a_s_Info = "")
    Local $l_p_BagPtr = GwAu3_ItemMod_GetBagPtr($a_v_BagNumber)
...
Func GwAu3_ItemMod_GetBagsItembyModelID($a_i_ModelID)
    ...
    For $l_i_Idx = 0 To UBound($l_ai_BagList) - 1
        Local $l_p_BagPtr = GwAu3_ItemMod_GetBagPtr($l_ai_BagList[$l_i_Idx])
        If $l_p_BagPtr = 0 Then ContinueLoop

        Local $l_ap_ItemArray = GwAu3_ItemMod_GetBagItemArray($l_ai_BagList[$l_i_Idx])
...
Func GwAu3_ItemMod_GetBagItemArray($a_v_BagNumber)
    Local $l_p_BagPtr = GwAu3_ItemMod_GetBagPtr($a_v_BagNumber)
    If $l_p_BagPtr = 0 Then Return 0

    Local $l_p_ItemArrayPtr = GwAu3_ItemMod_GetBagInfo($a_v_BagNumber, "ItemArray")
    If $l_p_ItemArrayPtr = 0 Then Return 0

    Local $l_i_Slots = GwAu3_ItemMod_GetBagInfo($a_v_BagNumber, "Slots")
...
Func GwAu3_ItemMod_GetItemBySlot($a_v_BagNumber, $a_i_Slot)
    If $a_i_Slot < 1 Or $a_i_Slot > GwAu3_ItemMod_GetBagInfo($a_v_BagNumber, "Slots") Then Return 0
...
Func GwAu3_ItemMod_ItemID($a_v_Item)
...
Func GwAu3_ItemMod_GetItemPtr($a_v_ItemID)
    If IsPtr($a_v_ItemID) Then Return $a_v_ItemID
    Local $l_ai_Offset[5] = [0, 0x18, 0x40, 0xB8, 0x4 * GwAu3_ItemMod_ItemID($a_v_ItemID)]
    Local $l_ap_ItemStructAddress = GwAu3_Memory_ReadPtr($g_p_BasePointer, $l_ai_Offset, "ptr")
    Return $l_ap_ItemStructAddress[1]
EndFunc   ;==>GetItemPtr

Func GwAu3_ItemMod_GetItemInfoByItemID($a_v_ItemID, $a_s_Info = "")
    Local $l_p_ItemPtr = GwAu3_ItemMod_GetItemPtr($a_v_ItemID)
    If $l_p_ItemPtr = 0 Or $a_s_Info = "" Then Return 0

    Return GwAu3_ItemMod_GetItemInfoByPtr($l_p_ItemPtr, $a_s_Info)
EndFunc   ;==>GetItemInfo

Func GwAu3_ItemMod_GetItemInfoByAgentID($a_i_AgentID, $a_s_Info = "")
    Local $l_i_ItemID = GwAu3_ItemMod_FindItemByAgentID($a_i_AgentID)
    If $l_i_ItemID = 0 Then Return 0

    If $a_s_Info = "" Then Return $l_i_ItemID
    Local $l_p_ItemPtr = GwAu3_ItemMod_GetItemPtr($l_i_ItemID)
    Return GwAu3_ItemMod_GetItemInfoByPtr($l_p_ItemPtr, $a_s_Info)
EndFunc   ;==>GetItemInfoByAgentID

Func GwAu3_ItemMod_GetItemInfoByModelID($a_i_ModelID, $a_s_Info = "")
    Local $l_i_ItemID = GwAu3_ItemMod_FindItemByModelID($a_i_ModelID)
    If $l_i_ItemID = 0 Then Return 0
...
Func GwAu3_ItemMod_GetItemInfoByPtr($a_p_ItemPtr, $a_s_Info)
    Switch $a_s_Info
        Case "ItemID"
...
Func GwAu3_ItemMod_FindItemByModelID($a_i_ModelID)
    Local $l_ap_ItemArray = GwAu3_ItemMod_GetItemArray()
...
Func GwAu3_ItemMod_FindItemByAgentID($a_i_AgentID)
    Local $l_ap_ItemArray = GwAu3_ItemMod_GetItemArray()
...
Func GwAu3_ItemMod_GetItemArray()
    Local $l_i_MaxItems = GwAu3_ItemMod_GetMaxItems()
