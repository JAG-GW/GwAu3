...
Func GwAu3_MapMod_GetInstanceInfo($a_s_Info = "")
...
Func GwAu3_MapMod_GetCurrentAreaInfo($a_s_Info = "")
    If $a_s_Info = "" Then Return 0
...
Func GwAu3_MapMod_GetCharacterInfo($a_s_Info = "")
    Local $l_p_Ptr = GwAu3_MapMod_GetCharacterContextPtr()
