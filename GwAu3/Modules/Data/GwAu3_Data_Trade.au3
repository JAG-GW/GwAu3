...
Func GwAu3_Trade_GetTradeInfo($a_s_Info = "")
    Local $l_p_Ptr = GwAu3_Trade_GetTradePtr()
...
Func GwAu3_Trade_GetPlayerTradeItemsInfo($a_i_TradeSlot = 0, $a_s_Info = "")
    Local $l_p_ItemsPtr = GwAu3_Trade_GetTradeInfo("PlayerItemsPtr")
    If $l_p_ItemsPtr = 0 Or $a_s_Info = "" Then Return 0

    Local $l_i_ItemCount = GwAu3_Trade_GetTradeInfo("PlayerItemCount")
    ...
    Switch $a_s_Info
        ...
        Case "ModelID"
            Return GwAu3_Item_GetItemInfoByPtr($l_p_ItemPtr, "ModelID")
    EndSwitch

    Return 0
EndFunc

Func GwAu3_Trade_GetPartnerTradeItemsInfo($a_i_TradeSlot = 0, $a_s_Info = "")
    Local $l_p_ItemsPtr = GwAu3_Trade_GetTradeInfo("PartnerItemsPtr")
    If $l_p_ItemsPtr = 0 Or $a_s_Info = "" Then Return 0

    Local $l_i_ItemCount = GwAu3_Trade_GetTradeInfo("PartnerItemCount")
    If $l_i_ItemCount = 0 Or $a_i_TradeSlot >= $l_i_ItemCount Then Return 0
...
Func GwAu3_Trade_GetArrayPlayerTradeItems()
    Local $l_i_ItemCount = GwAu3_Trade_GetTradeInfo("PlayerItemCount")
    ...
    For $l_i_Idx = 0 To $l_i_ItemCount - 1
        ; Read ModelID
        $l_ai2_Items[$l_i_Idx + 1][0] = GwAu3_Item_GetItemInfoByPtr(GwAu3_Memory_Read($l_p_ItemsPtr + ($l_i_Idx * 8), "long"), "ModelID")
        ; Read item quantity
...
Func GwAu3_Trade_GetArrayPartnerTradeItems()
    Local $l_i_ItemCount = GwAu3_Trade_GetTradeInfo("PartnerItemCount")
