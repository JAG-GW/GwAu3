...
Func GwAu3_Match_GetObserverMatchPtr($a_i_MatchNumber = 0)
...
Func GwAu3_Match_GetObserverMatchInfo($a_i_MatchNumber = 0, $a_s_Info = "")
    Local $l_p_Ptr = GwAu3_Match_GetObserverMatchPtr($a_i_MatchNumber)
    ...
    Switch $a_s_Info
        ...
        Case "Team1Name"
            ...
            Return GwAu3_Match_CleanTeamName(GwAu3_Memory_Read($l_p_TeamNamesPtr, "wchar[256]"))
        Case "TeamNames2Ptr"
            Return GwAu3_Memory_Read($l_p_Ptr + 0x74, "ptr")
        Case "Team2Name"
            Local $l_p_TeamNames2Ptr = GwAu3_Memory_Read($l_p_Ptr + 0x74, "ptr")
            Return GwAu3_Match_CleanTeamName(GwAu3_Memory_Read($l_p_TeamNames2Ptr, "wchar[256]"))
...
Func GwAu3_Match_CleanTeamName($a_s_Name)
