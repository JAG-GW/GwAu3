...
Func GwAu3_TradeMod_SellItem($a_i_ItemID, $a_i_Quantity = 1, $a_i_MerchantID = 0)
...
Func GwAu3_TradeMod_BuyItem($a_i_ItemID, $a_i_Quantity = 1, $a_i_Price = 0, $a_i_MerchantID = 0)
    If $a_i_ItemID <= 0 Then
        GwAu3_Log_Error("Invalid item ID: " & $a_i_ItemID, "TradeMod", $g_h_EditText)
        Return False
    EndIf
...
Func GwAu3_TradeMod_CraftItem($a_i_RecipeID, $a_i_Quantity = 1, $a_v_Materials = 0, $a_i_CrafterID = 0, $a_i_Flags = 0)
...
Func GwAu3_TradeMod_RequestQuote($a_i_ItemID)
    If $a_i_ItemID <= 0 Then
        GwAu3_Log_Error("Invalid item ID: " & $a_i_ItemID, "TradeMod", $g_h_EditText)
        Return False
    EndIf
...
Func GwAu3_TradeMod_RequestQuoteSell($a_i_ItemID)
    If $a_i_ItemID <= 0 Then
        GwAu3_Log_Error("Invalid item ID: " & $a_i_ItemID, "TradeMod", $g_h_EditText)
        Return False
    EndIf
...
Func GwAu3_TradeMod_SalvageItem($a_i_ItemID, $a_i_SalvageKitID, $a_i_SalvageType = $GC_I_SALVAGE_TYPE_NORMAL)
    If $a_i_ItemID <= 0 Then
        GwAu3_Log_Error("Invalid item ID: " & $a_i_ItemID, "TradeMod", $g_h_EditText)
        Return False
    EndIf
