...
#include "Modules/AgentMod_Data.au3"
#include "Modules/AgentMod_Commands.au3"
#include "Modules/AttributeMod_Data.au3"
#include "Modules/AttributeMod_Commands.au3"
#include "Modules/FriendMod_Data.au3"
#include "Modules/FriendMod_Commands.au3"
#include "Modules/GuildMod_Data.au3"
#include "Modules/GuildMod_Commands.au3"
#include "Modules/ItemMod_Data.au3"
#include "Modules/ItemMod_Commands.au3"
#include "Modules/MapMod_Data.au3"
#include "Modules/MapMod_Commands.au3"
#include "Modules/MatchMod_Commands.au3"
#include "Modules/MatchMod_Data.au3"
#include "Modules/OtherMod_Commands.au3"
#include "Modules/OtherMod_Data.au3"
#include "Modules/PartyMod_Commands.au3"
#include "Modules/PartyMod_Data.au3"
#include "Modules/QuestMod_Commands.au3"
#include "Modules/QuestMod_Data.au3"
#include "Modules/SkillMod_Data.au3"
#include "Modules/SkillMod_Commands.au3"
#include "Modules/TitleMod_Commands.au3"
#include "Modules/TitleMod_Data.au3"
#include "Modules/TradeMod_Data.au3"
#include "Modules/TradeMod_Commands.au3"
#include "Modules/UiMod_Commands.au3"
#include "Modules/UiMod_Data.au3"
...
Func DropBuff($a_i_SkillID, $a_v_AgentID, $a_i_HeroNumber = 0)
    Return GwAu3_Core_SendPacket(0x8, $GC_I_HEADER_BUFF_DROP, GwAu3_AgentMod_GetAgentBuffInfo(GwAu3_AgentMod_ConvertID($a_v_AgentID), $a_i_SkillID, "BuffID"))
EndFunc   ;==>DropBuff
...
Func TravelTo($a_i_MapID, $a_i_Language = GwAu3_MapMod_GetCharacterInfo("Language"), $a_i_Region = GwAu3_MapMod_GetCharacterInfo("Region"), $a_i_District = 0)
    If GwAu3_MapMod_GetCharacterInfo("MapID") = $a_i_MapID And GwAu3_MapMod_GetInstanceInfo("IsOutpost") _
...
Func WaitMapLoading($a_i_MapID = 0, $a_i_Deadlock = 10000, $a_b_SkipCinematic = False)
    ...
    Do
        Sleep(100)
        $l_i_TypeMap = GwAu3_Memory_Read(GwAu3_AgentMod_GetAgentPtr(-2) + 0x158, 'long')
...
Func WaitMapLoadingEx($a_i_MapID = -1, $a_i_InstanceType = -1)
    Do
        ...
        If GwAu3_OtherMod_GetGameInfo("IsCinematic") Then
            ...
            Sleep(1000)
        EndIf
    Until GwAu3_AgentMod_GetAgentPtr(-2) <> 0 And GwAu3_AgentMod_GetAgentArraySize() <> 0 And GwAu3_OtherMod_GetWorldInfo("SkillbarArray") <> 0 And GwAu3_PartyMod_GetPartyContextPtr() <> 0 _
...
Func GetModStruct($a_v_Item)
    ...
    Return GwAu3_Memory_Read(GwAu3_ItemMod_GetItemInfoByItemID($a_v_Item, "ModStruct"), 'Byte[' & GwAu3_ItemMod_GetItemInfoByItemID($a_v_Item, "ModStructSize") * 4 & ']')
